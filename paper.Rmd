...
uniform manifold alignment and projection (UMAP), and PHATE. The t-SNE algorithm estimates the similarity of (Euclidean) distances of points in a high dimensional space using a Gaussian distribution and then  
...
kernel for similiarites in the low dimensional space. Finally, PHATE is based
