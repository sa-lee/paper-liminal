...
Second, as $n$ increases the animation becomes slower as there is more data passing from the server to the client. Both of these issues could be mitigated
