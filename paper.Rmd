...
To begin, t-SNE transforms pairwise distances between  
$\mathbf{x_i}$ and $\mathbf{x_j}$  to similiarties using a Gaussian kernel:
...
$$
As the perplexity increases, $sigma_^2_{i}$ increases, until its bounded
...
parameterized [@Wattenberg2016-ji; @Kobak2019-lm]. If the goal is cluster
orientation a recent theoretical contribution by @Linderman2019-dq proved
