...
used in the literature: t-distributed stochastic neighbor embedding
(t-SNE) and uniform manifold alignment and projection (UMAP). The t-SNE
algorithm estimates the pairwise similarity of (Euclidean) distances of points in a high
