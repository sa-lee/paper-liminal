...
clusters. Both of these workflow steps rely on the embedding being 'faithful' to
the underlying high dimensional data, and become much more difficult when
there is no underlying ground truth. A further empirical study by @Sedlmair2013-pn, showed that when using embedding teqhinques, simple 2d scatter plots were an apporiate visualisation to help analysts perform these tasks but they did note that 
depending on the underlying goal multiple dimensionality reduction techniques
are necessary. 
