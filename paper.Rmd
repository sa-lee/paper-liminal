...
In the second case study, we look at well-clustered single cell
...
along side the tSNE view which was computed from all 25 PCs. Due to latency
of the interface we do a ten percent weighted sample of rows based on
cluster membership. 
