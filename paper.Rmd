...
along side the tSNE view which was computed from all 25 PCs. 
...
linked brushing. As expected avoids tSNE mitigates the crowding problem that is
...
magnitude of expression in these genes is similar accross these groups, 
